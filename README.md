...
- when Premiere exposes a `Shape` component plus a nested `Align and Transform` subsection, Sub Creator merges them into one `Shape` block so the controls stay closer to the panel you see in Premiere
