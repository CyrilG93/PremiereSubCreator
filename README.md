...
- Released the Apple Silicon macOS installer as a Developer ID signed and Apple-notarized package.

### 1.2.17 - 2026-08-25

- Simplified DeepL translation of native Premiere subtitles: SRT files generated by Sub Creator now open automatically in the Translation tab.
- Removed the optional source-timing setting to keep the generation interface focused on translation.
