...
- Visual editor uses inline color controls (`HEX` + `RGB` + clickable `H/S/L` palette opened from the color swatch) instead of browser popups, avoiding CEP picker clipping and pipette limitations.
