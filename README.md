...
- Visual editor uses inline color controls (`HEX` + `RGB` + clickable `H/S/L` palette) instead of browser popups, avoiding CEP picker clipping and pipette limitations.
